    ...
    <div class="app-container">
        ...
        <el-dialog :visible.sync="progressDialogVisible" title="报修进度" width="55%">
            <el-steps :active="processInfo.step" align-center>
                ...
                <el-step title="正在购买" :description="processInfo.grantTimestamp | parseTime('{y}-{m}-{d} {h}:{i}:{s}')"></el-step>
...
<script>
import { getApplyList, countApplyList, updateApply, addRecord } from "@/api/cost";
...
const statusOptions = [
    ...
    {key: "正在购买", value: "GRANTED"},
    {key: "已购买", value: "FINISHED"},
